...
class CreateConditionNotificationPHR extends StatelessWidget {
  
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: const Text("Create Condition Notification PHR Page")),
        body: MyCustomForm());
  }
}
            ...
            Container(
              ...
              child: ElevatedButton(
                onPressed: () async {
                  ...
                  var resultMessage = await notifDataController.postConditionNotif(phrIdController.text);
